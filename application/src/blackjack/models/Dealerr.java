...
public class Dealerr {

    LinkedList<PlayerHand> playerHands = new LinkedList<>();
    ...
    public void playerDealOne(PlayerHand playerHand) {    //För newRound och dealern
    ...
    public void playerHit(PlayerHand playerHand) {
        if (cardDeck.percentageLeft() <= reShuffle) {
            cardDeck = new CardDeck(7);
        }
    ...
    public void doubleHand(PlayerHand playerHand) {
        if (cardDeck.percentageLeft() < reShuffle) {
            cardDeck = new CardDeck(7);
        }
    ...
    public void playerStand(PlayerHand playerHand) {
        //next playerHand          //Deala nästa hand
    }

    public boolean blackJack(PlayerHand playerHand) {
    ...
    public void dealDealer(PlayerHand dealerHand) {
